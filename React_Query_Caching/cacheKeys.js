...
export const CACHE_CONFIG = {
  ...
  PAGE_MIXED_BLOGS_TOTAL_COUNT: {
    staleTime: 2 * 60 * 1000, // 2 minutes for total count of mixed blogs
    maxAge: 7 * 24 * 60 * 60 * 1000, // 7 days
    enableOffline: true,
  },
  // Config for mixed blogs paginated data
  PAGE_MIXED_BLOGS_PAGINATED: {
    staleTime: 1 * 60 * 1000, // 1 minute for paginated mixed blogs
    maxAge: 7 * 24 * 60 * 60 * 1000, // 7 days
    enableOffline: true,
  },
  ...
  PAGE_FREERESOURCES_COUNTS: { staleTime: 5 * 60 * 1000, maxAge: 7 * 24 * 60 * 60 * 1000, enableOffline: true, },
