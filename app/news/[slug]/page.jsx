...
export default async function ParentPage({ params }) {
  function schemaBlogPostingMarkup() {
    return {
      __html: `
      {
        ...
        "url": "https://www.doitwithai.tools/news/${params.slug}",
      ...
      __html: `
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 2,
            "item": {
              "@id": "https://www.doitwithai.tools/news",
              "name": "AI Tools"
            }
          },
          {
            ...
            "position": 3,
            "item": {
              "@id": "https://www.doitwithai.tools/news/${params.slug}",
  ...
  const canonicalUrl = `https://www.doitwithai.tools/news/${params.slug}`;
