...
async function getData(slug) {
  ...
  const query = `*[_type == "coding" && slug.current == "${slug}"][0]{
    ...
    displaySettings // For conditional SoftwareApplication schema (if applicable to 'coding' schema)
  }`;
  try {
...
export async function generateMetadata({ params }) {
  ...
  if (!data) {
    return {
      ...
      description: 'The requested AI Code article page was not found.',
    };
  }

  const imageUrl = data.mainImage ? urlForImage(data.mainImage).url() : null;
  const canonicalUrl = `https://www.doitwithai.tools/ai-code/${params.slug}`; // Correct URL for coding articles
  ...
  return {
    ...
    category: 'AI in Coding & Development', // Specific category for coding
    classification: 'Technology, Software Development, Programming', // More specific classification
    robots: {
      index: true,
      follow: true,
    ...
    openGraph: {
      ...
      section: 'AI in Coding & Development', // Specific section
...
export default async function ParentPage({ params }) {
  ...
  if (!data) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        ...
        <p className="text-gray-600">The AI Code article you're looking for doesn't exist.</p>
      </div>
    );
  }
  ...
  function generateArticleSchema() {
    ...
    return {
      __html: JSON.stringify({
        ...
        "@type": ["Article", "TechArticle", "Code"], // TechArticle, Code for coding content
        ...
        "articleSection": "AI in Coding & Development", // Consistent with your category
        ...
        "author": {
          ...
          "knowsAbout": ["Artificial Intelligence", "AI Tools", "SEO", "Content Marketing", "Digital Marketing", "Programming", "Software Development"], // Expanded
          "sameAs": [
        ...
        "about": {
          ...
          "sameAs": "https://en.wikipedia.org/wiki/Artificial_intelligence_in_software_engineering" // Link to AI in Software Engineering Wikipedia
        },
        ...
        "educationalLevel": "beginner, intermediate, advanced", // Changed for coding audience
        "learningResourceType": "code example, tutorial, guide, technical article", // More specific
        "potentialAction": [
          {
            "@type": "ReadAction",
            "target": [canonicalUrl]
      ...
      __html: JSON.stringify({
        ...
        "itemListElement": [
          ...
          },
          {
            "@type": "ListItem",
            "position": 2,
            "name": "AI Code", // Specific breadcrumb name
            "item": {
              "@type": "WebPage",
              "@id": "https://www.doitwithai.tools/ai-code", // Specific breadcrumb URL
  ...
  function generateSoftwareApplicationSchema() {
    // Check if displaySettings and isSoftwareReview are true (if your 'coding' schema has this)
    ...
    return {
      __html: JSON.stringify({
        ...
        "description": data.metadesc,
        "url": canonicalUrl,
        "applicationCategory": "Developer Tool", // Specific category for coding tools
        "applicationSubCategory": "Programming Tool", // Specific subcategory
        ...
        "featureList": data.tags?.map(tag => tag.name) || ["Programming", "Code Generation", "Development Tools"],
  ...
  return (
    <>
      <Head>
        ...
        <meta name="classification" content="Technology, Software Development, Programming" />
        <meta name="category" content="AI in Coding & Development" />
        <meta name="coverage" content="Worldwide" />
        <meta name="distribution" content="Global" />
        <meta name="rating" content="General" />
        <meta name="subject" content="AI in Software Development" />
        <meta name="topic" content="AI Technology for Programming" />
        ...
        <NextSeo
          ...
          openGraph={{
            ...
            publishedTime: data.publishedAt,
            modifiedTime: data._updatedAt,
            section: 'AI in Coding & Development',
            tags: data.tags?.map(tag => tag.name) || [],
          }}
          twitter={{
            card: 'summary_large_image',
