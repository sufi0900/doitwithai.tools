...
<h3 className="border-b border-black border-opacity-10 px-8 py-4 text-lg font-semibold text-black dark:border-white dark:border-opacity-10 dark:text-white">
    ...
    date={new Date(blog.publishedAt).toLocaleDateString('en-US', { day: 'numeric', month: 'short', year: 'numeric' })}{...blog}
/>
</li>
</ul>
</div>
  ...
  useEffect(() => {
    const fetchData = async () => {
      const query = `*[_type == "makemoney"][0...50] | order(_createdAt desc)`;
