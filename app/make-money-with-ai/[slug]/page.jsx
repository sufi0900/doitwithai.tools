...
export default async function ParentPage({ params }) {
  function schemaBlogPostingMarkup() {
    return {
      __html: `
      {
        ...
        "url": "https://sufi-blog-website.vercel.app/make-money-with-ai/${params.slug}",
      ...
      __html: `
      {
        ...
        "itemListElement": [
          ...
          },
          {
            ...
            "position": 2,
            "item": {
              "@id": "https://sufi-blog-website.vercel.app/make-money-with-ai",
              "name": "AI Tools"
            }
          },
          {
            ...
            "position": 3,
            "item": {
              "@id": "https://sufi-blog-website.vercel.app/make-money-with-ai/${params.slug}",
  ...
  const canonicalUrl = `https://sufi-blog-website.vercel.app/make-money-with-ai/${params.slug}`;
