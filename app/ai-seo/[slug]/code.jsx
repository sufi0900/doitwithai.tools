...
// This function is for "All Blogs" (pagination), not directly related to the related posts issue,
...
async function fetchRelatedPostsData(currentPostId) {
  ...
  const query = `*[_type == "seo" && _id != $excludeId] | order(_createdAt desc) [0...3]`;
