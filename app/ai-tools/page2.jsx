...
export default  function Page() {
  ...
  function schemaMarkup() {
    ...
    const itemList = categoriesData.map((category) => ({
      ...
      "url": `https://doitwithai.tools/ai-tools/${category.link}`,
    }));
    ...
    return {
      __html: `  {
        ...
        "url": "https://doitwithai.tools/ai-tools",
        "author": {
          "@type": "Organization",
          "name": "Sufian Mustafa"
        },
        ...
        "mainEntityOfPage": {
          "@type": "WebPage",
          "@id": "https://doitwithai.tools/ai-tools",
          "mainEntity": {
            "@type": "ItemList",
            "name": "Best AI Tools",
            "description": "A comprehensive list of the best AI tools for productivity and creativity, carefully curated to enhance your digital workflows.",
  ...
  function BreadcrumbListSchema() {
    ...
    "itemListElement": [
        ...
        },
        {
            ...
            "position": 2,
            "name": "AI Tools",
            "item": "https://doitwithai.tools/ai-tools"
        }
    ]
      }`
    };
 ...
 <meta property="og:image:height" content="630" />
  ...
  <meta property="og:url" content="https://doitwithai.tools/ai-tools" />
        ...
        <meta property="twitter:url" content="https://doitwithai.tools/ai-tools" />
  ...
  <link rel="canonical" href="https://doitwithai.tools/ai-tools"/>
        ...
        <NextSeo
         ...
         description={metadata.description}
          ...
          canonical="https://doitwithai.tools/ai-tools"
          openGraph={{
            title: metadata.title,
            description: metadata.description,
            url: "https://doitwithai.tools/ai-tools",
