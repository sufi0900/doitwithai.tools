...
export default function AllBlogs() {
  ...
  useEffect(() => {
      const fetchData = async () => {
          try {
            ...
            const isHomePageAIToolTrendBig = `*[_type == "makemoney" && displaySettings.isOwnPageFeature == true] {
              _id,
              title,
              overview,
              mainImage,
  ...
  const handleSearch = async () => {
    ...
    const query = `*[_type == "makemoney" && (title match $searchText || content match $searchText)]`;
