...
<section className="text-center mb-12 sm:mb-16 lg:mb-20">
  ...
  {/* Shortened, SEO-optimized Description */}
  <p className="mx-auto max-w-2xl sm:max-w-3xl lg:max-w-4xl px-4 sm:px-6 text-sm xs:text-base sm:text-lg md:text-xl lg:text-xl text-gray-600 dark:text-gray-300 leading-relaxed">
    Explore expert-led AI SEO insights and actionable guides designed for modern search. 
    Master human-AI workflows for content creation, GEO, and AEO to scale your business 
    and stay ahead of every emerging digital trend.
  </p>
  ...
  <div className="mt-6 sm:mt-8 md:mt-10 flex flex-col xs:flex-row flex-wrap justify-center items-center gap-4 sm:gap-6 md:gap-8 lg:gap-10">
    <div className="text-center min-w-[80px]">
      ...
      <div className="text-xs xs:text-sm text-gray-600 dark:text-gray-400 mt-1 uppercase tracking-wider font-medium">Articles</div>
    </div>
    <div className="text-center min-w-[80px]">
      <div className="text-xl xs:text-2xl sm:text-3xl md:text-3xl font-bold text-indigo-600 dark:text-indigo-400">4</div>
      <div className="text-xs xs:text-sm text-gray-600 dark:text-gray-400 mt-1 uppercase tracking-wider font-medium">Categories</div>
    </div>
    <div className="text-center min-w-[80px]">
      <div className="text-xl xs:text-2xl sm:text-3xl md:text-3xl font-bold text-teal-600 dark:text-teal-400">Weekly</div>
      <div className="text-xs xs:text-sm text-gray-600 dark:text-gray-400 mt-1 uppercase tracking-wider font-medium">Updates</div>
    </div>
  </div>
</section>
