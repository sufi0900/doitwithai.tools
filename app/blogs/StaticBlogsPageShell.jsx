...
// Components
import Breadcrumb from "@/components/Common/Breadcrumb"; // Assuming this might be used elsewhere
import FilterIcon from '@mui/icons-material/FilterList'; // Icons are imported but not used directly in this shell
import SortIcon from '@mui/icons-material/Sort';
import SearchIcon from '@mui/icons-material/Search';
import ClearIcon from '@mui/icons-material/Clear';
import CalendarTodayIcon from '@mui/icons-material/CalendarToday';
import PageCacheStatusButton from "@/React_Query_Caching/PageCacheStatusButton"; // If you want this on the server shell
        ...
        <section className="text-center mb-16">
          <h1 className="mb-6 text-4xl md:text-5xl lg:text-6xl font-black tracking-tight text-gray-900 dark:text-white">
            <span className="relative inline-block mr-3">
              ...
              <span className="absolute bottom-0 left-0 h-2 w-full bg-gradient-to-r from-blue-500 to-indigo-600 rounded-full"></span>
            </span>
