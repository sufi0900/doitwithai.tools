// 1. Create components/SidebarRelatedResources.js
  ...
  if (isLoading) {
    return (
      <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-white via-white to-gray-50/30 shadow-lg hover:shadow-xl dark:from-gray-800 dark:via-gray-800 dark:to-gray-900/50 dark:shadow-gray-900/20 transition-all duration-500">
        <div className="absolute inset-0 bg-gradient-to-r from-orange-500/10 via-red-500/10 to-pink-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          ...
          <ul className="p-6 space-y-4">
            {displayResources.map((resource, index) => (
              <li key={resource._id} className="group/item relative">
                <div className="absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-orange-500 to-red-600 scale-y-0 group-hover/item:scale-y-100 transition-transform duration-300 origin-top rounded-full"></div>
            ...
            <li className="pt-4">
              <a 
                ...
                className="block group/link relative overflow-hidden rounded-lg bg-gradient-to-r from-orange-500 to-red-600 p-3 text-center transition-all duration-300 hover:shadow-lg hover:scale-[1.02]"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-red-600 to-orange-500 opacity-0 group-hover/link:opacity-100 transition-opacity duration-300"></div>
