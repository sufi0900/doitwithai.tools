...
import ResourceCard from '@/app/free-resources/RelatedesourceCard';
import Link from 'next/link';
import ResourceSkeleton from '@/app/free-resources/ResourceSkeleton';
import ResourceModalsProvider from '@/app/free-resources/ResourceModalsProvider';
const DynamicResourceCarousel = dynamic(() => import('@/app/free-resources/ResourceCarousel'), {
  ssr: false,
  loading: () => (
